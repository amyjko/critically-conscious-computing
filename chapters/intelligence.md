...
|Chapter06_Figure06_Library.png|A massive wall of books with stairs leading to them, with bright magenta sections of books highlighted and an ominous Google Search text box hovering in the center behind the walls.|What did we gain by automating the work of librarians? What did we lose?|Jessie Huynh [CC0|https://creativecommons.org/publicdomain/zero/1.0/]|
