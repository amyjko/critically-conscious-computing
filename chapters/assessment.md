...
|Chapter03_Figure02_Judging.png|A scantron sheet with a woman in a cap and gown and a blue bar over her eyes, a magnifying glass over her shoulder, and a 3.5 below her chin.|Why do we assess?|Jessie Huynh [CC0|https://creativecommons.org/publicdomain/zero/1.0/]|
...
|Chapter03_Figure03_Reflecting.png|A circle with a child peering down inside its contents. Pixelated things and people inside, with code in the background.|There are a lot of different things to know about CS, and no one can know them all.|Jessie Huynh [CC0|https://creativecommons.org/publicdomain/zero/1.0/]|
...
Such questions require students to understand the syntax and semantics of a programming language, to trace the program’s manipulation and computation of data. Different prompts can exercise different skills; for example, the item above could have asked the student to select a line of code to change the behavior of the program, or to identify a line of code that caused incorrect output. All of these exercise a students’ ability to reason as a computer does, which is a key skill in writing computer programs. Such assessments have been used to construct "CS concept inventories", which attempt to robustly and reliably measure students’ knowledge of basic programming concepts<tew11,parker16>, as well as Advanced Placement CS exams<lewis13,drysdale05>
...
|question.jpg|TODO|TODO Something to convey a broader context of caring feedback.|TODO|
...
* That students see themselves as powerful and capable of using computing, rather than simply being subject to computing tools.
* That students can articulate ways that computing can be used to address systemic or local inequities.
