...
|Chapter16_Figure02_DiversityCode.png|Four people of different races and genders, set in front four different contexts, each creating computational things.|Everyone codes, when they need to or want to.|@jessie|<
