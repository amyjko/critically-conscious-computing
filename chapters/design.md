...
|Chapter05_Figure02_Sketching.png|A woman at a desktop computer sketching on a desk with green sketches in the backdrop.|Deciding _what_ software should do is a different skill than deciding _how_ it should do it.|Jessie Huynh [CC0|https://creativecommons.org/publicdomain/zero/1.0/]|
...
|Chapter05_Figure03_SoftwarEengineers.png|A group of four people, one in a wheelchair at a computer, all looking at a screen full of green code.|Whereas design is expansive, engineering is narrowing.|Jessie Huynh [CC0|https://creativecommons.org/publicdomain/zero/1.0/]|
...
|Chapter05_Figure04_PrototypeCollab.png|Five people sitting around and on top of a graphical user interface, with five different large mouse cursors hovering around them.|Doing design requires the abiilty to focus on people, their problems, _and_ the technologies and processes that might help them.|Jessie Huynh [CC0|https://creativecommons.org/publicdomain/zero/1.0/]|
...
|Chapter05_Figure05_Constructionism.png|A child constructing legos, but the legos are in their own mind|Teaching CS _as_ design has some benefits, but masks design as a distinct skill.|Jessie Huynh [CC0|https://creativecommons.org/publicdomain/zero/1.0/]|
...
|Chapter05_Figure06_APCSProblem.png|An AP CS A exam question, which includes a class declaration and a question that prompts the student to write a method|Engineering-centered pedagogies focus on problem solving, as in this AP CS exam prompt.|Jessie Huynh [CC0|https://creativecommons.org/publicdomain/zero/1.0/]|
...
|Chapter05_Figure07_Alternating.png|Two Black girls, both emerging from the two sides of the Chinese yin-yang symbol, one working on hardware and the other on 3D geometries.|Design and engineering is a never-ending duality, and should be taught as such.|Jessie Huynh [CC0|https://creativecommons.org/publicdomain/zero/1.0/]|
