...
|question.jpg|TODO|A depiction of a social media profile showing lots of metadata about a person, such as their name, location, interests, etc., but also not faithfully representing the person entirely, providing an example of a named record and its approximation of reality.|@ashley|
...
|question.jpg|TODO|A depiction of a large table of data with column names and row numbers and people narrowly crammed inside each row, represented by the values in the table.|@ashley|
