...
|question.jpg||TODO A depiction of many different algorithms, some for sorting, some for searching, some for translating, some for finding routes. So many algorithms! And yet all of them are problematic in some way.||
