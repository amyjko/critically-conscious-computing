...
Here we offer project-based learning approaches that integrate questions of diversity, equity, inclusion, and justice into project planning. One approach is to focus on project scopes that engage computing as a tool for dismantling systems of oppression; the other is to integrate examinations of diversity, equity, and inclusion into the workflow scaffolding of project work, helping students to see diversity concerns as integral to software engineering projects. Below we describe an example unit sketch that uses both of these approaches.
...
Projects aren't specific to CS: every discipline has methods of organizing groups of people to create and accomplish greater things than they could alone, every discipline requires project management skills to have impact, and every project intersects with diversity, equity, inclusion, and justice. What makes projects in CS unique is the constraints that tools and concepts in the discipline impose upon projects (e.g., languages are designed to make some things easier to build than others), and the great capacity for impact good and bad if a software project becomes widely used. Software engineering is all about navigating these constraints and figuring out how to harness this capacity best.
