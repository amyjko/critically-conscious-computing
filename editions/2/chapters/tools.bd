...
|Screenshot-Xcode.png|A screenshot of the Xcode IDE showing a running program paused on a line, a call stack, and a lis of variables within the call stack.|The [Xcode IDE|https://developer.apple.com/xcode/] for developing Apple applications, and its breakpoint debugging view, which allows developers to inspect an executing program's behavior|Apple ©|>
...
We offer one possible approach to this transparency in the unit sketch below, which teaches students about the [VS Code IDE|https://code.visualstudio.com], an IDE used by many developers to create web applications and build data science applications.
