...
|Chapter05_Figure02_Sketching.png|A woman at a desktop computer sketching on a desk with green sketches in the backdrop.|Deciding _what_ software should do is a different skill than deciding _how_ it should do it.|Jessie Huynh|
...
|Chapter05_Figure03_SoftwarEengineers.png|A group of four people, one in a wheelchair at a computer, all looking at a screen full of green code.|Whereas design is expansive, engineering is narrowing.|Jessie Huynh|
