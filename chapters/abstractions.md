...
|||TODO Something that conveys a whole bunch of computational complexity inside some container, most of which is invisible outside the container, which has a very simple and limited interface||
...
|||TODO Something that conveys the idea of inputs going into a black box, and outputs coming out, with no visibility about what’s inside. Ideally, there are a fixed number of inputs, and they are a diversity of things, like numbers and words, and there is one output, which could be anything.||
...
|||TODO Something that conveys a very important, very interesting black box (like Google Search), and many people trying to see inside it, but it is heavily guarded and controlled||
...
|||TODO A portrayal of teachers and students talking about black boxes with secret insides and inspectable outsides.||
