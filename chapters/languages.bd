...
Computers, unfortunately, have none of this shared context, knowledge, or culture; programming languages, therefore, are quite unlike natural languages. Instead, programming languages require utmost precision in how we communicate with them, leaving _no_ room for ambiguity. And if we precisely communicate an instruction to a computer that we did not intend, it will not use context, knowledge, or culture to do what we meant; it will just do what we said, and it is up to us to notice it that it didn't do what we wanted and learn how the machine interpreted what we said.
